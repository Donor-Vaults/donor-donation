...
var BigCard = function BigCard(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(Box, null, /*#__PURE__*/_react.default.createElement(Upper, null, /*#__PURE__*/_react.default.createElement("img", {
    src: "".concat(props.img ? props.img : "https://archive.org/download/03-05-2016_Images_Images_1-30/01_PT_hero_42_153645159.jpg"),
    alt: "",
    style: {
      width: "100%",
      height: "100%",
  ...
  }, "As the country heals, it still feels like we're lagging where hunger still remains an urgency even if the pandemic is not.", /*#__PURE__*/_react.default.createElement("div", {
    style: {
      margin: '1.5rem 0'
    }
  }, "If it was bad, it's becoming even worse."), "The people have suffered for nearly 2 years now, and very soon, we will reach to point of HUNGER CRISIS; they will die of HUNGER before the virus hits them.")));
};
