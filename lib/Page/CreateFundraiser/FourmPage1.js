...
var _WideBox = _interopRequireDefault(require("./components/WideBox"));
var _you = _interopRequireDefault(require("./components/you.svg"));
var _charity = _interopRequireDefault(require("./components/charity.svg"));
var _other = _interopRequireDefault(require("./components/other.svg"));
...
var Flex = _styledComponents.default.div(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  width: 90%;\n  display: flex;\n  justify-content: space-between;\n  margin: 1rem 0 0 0;\n"])));
var H = _styledComponents.default.h1(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  color: #fff;\n  font-size: 2rem;\n  font-weight: light;\n  margin-bottom: 2rem;\n  text-align: left !important;\n  @media only screen and (max-width: 768px) {\n    font-weight: 510;\n    font-size: 1.2rem;\n    font-weight: bold;\n  }\n"])));
var T = _styledComponents.default.p(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  color: #fff;\n  font-weight: 500;\n  font-size: 1.2rem;\n  margin-bottom: 2rem;\n  // text-align: center;\n  //width: 20rem;\n\n  @media only screen and (max-width: 768px) {\n    font-weight: 510;\n    font-size: 1rem;\n  }\n"])));
var Left = _styledComponents.default.div(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  width: 40%;\n  height: 100%;\n  display: flex;\n  justify-content: center;\n  flex-direction: column;\n  padding: 0 2rem;\n  //margin: 5rem 0 0 0;\n  background: #ffffff;\n  border-radius: 1.75rem;\n  box-shadow: rgba(50, 50, 93, 0.25) 0px 50px 100px -20px,\n    rgba(0, 0, 0, 0.3) 0px 30px 60px -30px,\n    rgba(10, 37, 64, 0.35) 0px -2px 6px 0px inset;\n\n  @media only screen and (max-width: 1100px) {\n    width: 100%;\n    margin: 6rem 0 0 0;\n  }\n"])));
...
var Margin = _styledComponents.default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  margin: 5rem 0 0 0;\n\n  @media only screen and (max-width: 1100px) {\n    margin: 3rem 0 0 0;\n  }\n"])));
var MarginLeft = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  margin: 0 1rem 0 4rem;\n\n  @media only screen and (max-width: 1100px) {\n    margin: 0 1rem;\n  }\n"])));
var Grid = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  width: 100%;\n  margin: 1.5rem 0 0 0;\n  // grid-template-columns: repeat(auto-fit, minmax(9rem, 1fr));\n  //  grid-gap: 2rem 0.5rem;\n"])));
var Back = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  margin: 1rem 2rem 1rem 0;\n  cursor: pointer;\n\n  @media only screen and (max-width: 998px) {\n    position: absolute;\n    top: 1rem;\n    right: 0.5rem;\n  }\n"])));
var Details = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  background: linear-gradient(\n      180deg,\n      rgba(2, 169, 92, 0.5) 0%,\n      rgba(34, 170, 48, 0.5) 100%\n    ),\n    linear-gradient(0deg, #ffffff, #ffffff);\n\n  padding: 3rem 2rem 2rem 2rem;\n  border: 0.25rem solid #ffffff;\n  border-radius: 1.25rem;\n  margin: 0 1rem 4rem 1rem;\n"])));
var FourmPage1 = function FourmPage1(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement(Sec, {
  ...
  }, "Tell our community more about the fundraiser"), /*#__PURE__*/_react.default.createElement(T, {
    style: {
      color: "#000"
    }
  }, "Donors will know your fundraising needs"))), /*#__PURE__*/_react.default.createElement(Right, null, /*#__PURE__*/_react.default.createElement(Back, {
    style: {
      display: "flex",
      alignItems: "flex-end",
  ...
  }, "Back"))), /*#__PURE__*/_react.default.createElement(Details, null, user.user_role === "USER" ? null : /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(T, {
    style: {
      margin: "0 0 0.5rem 0",
      fontSize: "1.6rem"
    }
  }, "Your Name"), /*#__PURE__*/_react.default.createElement(Flex, null, /*#__PURE__*/_react.default.createElement("input", {
    type: "Text",
  ...
  }, "Fundraiser beneficiary"), /*#__PURE__*/_react.default.createElement(Grid, null, /*#__PURE__*/_react.default.createElement(_WideBox.default, {
    ...
    image: _you.default
  }), /*#__PURE__*/_react.default.createElement(_WideBox.default, {
    value: data.benificiary,
    onClick: function onClick(t) {
      console.log("dsasasasa", t);
      setData(_objectSpread(_objectSpread({}, data), {}, {
        benificiary: t
      }));
    },
