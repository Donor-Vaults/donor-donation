...
var _img = _interopRequireDefault(require("./components/img.svg"));
...
var Cross = _styledComponents.default.div(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  position: absolute;\n  top: 1rem;\n  right: 2rem;\n  z-index: 99;\n"])));
exports.Cross = Cross;
var Input = _styledComponents.default.input(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral([""])));
var H = _styledComponents.default.h1(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  color: #fff;\n  font-size: 2rem;\n  font-weight: light;\n  margin-bottom: 2rem;\n  text-align: left !important;\n  @media only screen and (max-width: 768px) {\n    font-weight: 510;\n    font-size: 1.2rem;\n    font-weight: bold;\n  }\n"])));
var T = _styledComponents.default.p(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  color: #fff;\n  font-weight: 500;\n  font-size: 1.2rem;\n  margin-bottom: 2rem;\n  // text-align: center;\n  //width: 20rem;\n\n  @media only screen and (max-width: 768px) {\n    font-weight: 510;\n    font-size: 1rem;\n  }\n"])));
var Left = _styledComponents.default.div(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  width: 40%;\n  height: 100%;\n  display: flex;\n  justify-content: center;\n  flex-direction: column;\n  padding: 0 2rem;\n  //margin: 5rem 0 0 0;\n  background: #ffffff;\n  border-radius: 1.75rem;\n  box-shadow: rgba(50, 50, 93, 0.25) 0px 50px 100px -20px,\n    rgba(0, 0, 0, 0.3) 0px 30px 60px -30px,\n    rgba(10, 37, 64, 0.35) 0px -2px 6px 0px inset;\n\n  @media only screen and (max-width: 1100px) {\n    width: 100%;\n    margin: 6rem 0 0 0;\n  }\n"])));
var Right = _styledComponents.default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n  flex-direction: column;\n  // align-items: center;\n  width: 60%;\n  // padding: 5rem 0 3rem 0;\n  border-radius: 2rem 0 0 0;\n  // background-color: rgba(255,255,255,0.9);\n  // box-shadow: rgba(50, 50, 93, 0.25) 0px 50px 100px -20px, rgba(0, 0, 0, 0.3) 0px 30px 60px -30px, rgba(10, 37, 64, 0.35) 0px -2px 6px 0px inset;\n\n  @media only screen and (max-width: 1100px) {\n    width: 100%;\n    margin: 3rem 0 0 0;\n  }\n"])));
...
var MarginLeft = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  margin: 0 1rem 0 4rem;\n\n  @media only screen and (max-width: 1100px) {\n    margin: 0 1rem;\n  }\n"])));
var Grid = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  display: grid;\n  width: 100%;\n  margin: 3rem 0 0 0;\n  grid-template-columns: repeat(auto-fit, minmax(9rem, 1fr));\n  grid-gap: 2rem 0.5rem;\n"])));
var Back = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  margin: 1rem 2rem 1rem 0;\n  cursor: pointer;\n\n  @media only screen and (max-width: 998px) {\n    position: absolute;\n    top: 1rem;\n    right: 0.5rem;\n  }\n"])));
...
var FourmPage3 = function FourmPage3(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement(Sec, {
  ...
  }, "Add a photo/video"), /*#__PURE__*/_react.default.createElement(T, {
    style: {
      color: "#000"
    }
  }, " ", "Please ensure the photo/video is clear and bright so that people will look at your fundraiser"))), /*#__PURE__*/_react.default.createElement(Right, null, /*#__PURE__*/_react.default.createElement(Back, {
  ...
  }, "Back"))), /*#__PURE__*/_react.default.createElement(Details, null, /*#__PURE__*/_react.default.createElement(InputContainer, {
    onClick: function onClick() {
      inputFile.current.click();
    }
  }, data.featuredImage ? /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(Cross, null, /*#__PURE__*/_react.default.createElement(_im.ImCross, {
    style: {
      fontSize: '1.75rem'
    },
    onClick: function onClick() {
    ...
    type: "image",
    src: data.featuredImage ? URL.createObjectURL(data.featuredImage) : _img.default,
    alt: "",
    className: "input1",
    style: {
      height: "3rem",
  ...
  }, "Upload the photo/video here")), /*#__PURE__*/_react.default.createElement("input", {
    type: "file",
    id: "file",
    ref: inputFile,
    ...
    onChange: function onChange(f) {
      if (f.target.files.length > 0) {
        setData({
          featuredImage: f.target.files[0]
        });
      }
    },
    style: {
