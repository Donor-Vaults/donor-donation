...
var FourmPage4 = function FourmPage4(_ref) {
  var _ref2, _ref3;
  ...
  var validate = function validate() {
    if (!data.fundraiserName) {
      alert("Please Enter Fundraisers Name");
      return false;
    }
    if (!data.fundraiserDescription) {
      alert("Please Enter Fundraisers Description");
      return false;
    }
    return true;
  };
  ...
  return /*#__PURE__*/_react.default.createElement(Sec, {
    ...
    onChange: function onChange(t) {
      setData(_objectSpread(_objectSpread({}, data), {}, {
        fundraiserDescription: t.target.value
      }));
    },
    ...
    style: (_ref3 = {
      ...
      border: '1px solid rgba(0,0,0,0.2)',
      borderRadius: '0.75rem'
    }, _defineProperty(_ref3, "width", '100%'), _defineProperty(_ref3, "margin", '2rem 0 0 0'), _defineProperty(_ref3, "padding", "0 0 0 2rem"), _ref3)
  })), /*#__PURE__*/_react.default.createElement("div", {
    style: {
      display: 'grid',
      placeItems: 'center'
