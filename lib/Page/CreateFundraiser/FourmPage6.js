...
var _DonationFactory = _interopRequireDefault(require("../../config/abi/DonationFactory.json"));
var _config = _interopRequireDefault(require("../../config"));
var _FundRaisersPreview = _interopRequireDefault(require("./components/FundRaisersPreview"));
...
var FundPreview = function FundPreview(_ref) {
  var data = _ref.data,
    onNext = _ref.onNext,
    hide = _ref.hide,
    onBack = _ref.onBack;
  ...
  var _useState3 = (0, _react.useState)(""),
    ...
    contractAddress = _useState4[0],
    setContractAddress = _useState4[1];
  var _useState5 = (0, _react.useState)(),
    _useState6 = _slicedToArray(_useState5, 2),
    factorycontract = _useState6[0],
    setFactoryContract = _useState6[1];
  ...
  var loadContract = function loadContract() {
    var _web3 = new _web.default(wallet.ethereum);
    var _factory = new _web3.eth.Contract(_DonationFactory.default, _config.default.FACTORY);
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 1;
            _context.next = 4;
            return factorycontract.methods.createCampaign().send({
              from: wallet.account
            });
          case 4:
            resp = _context.sent;
            console.log("deployContract", resp);
            _address = resp.events.onCreateCampaign.returnValues.campaginAddress;
          ...
          case 10:
            ...
            console.error("wasasasas", _context.t0);
          case 13:
            setLoading(false);
          case 14:
          case "end":
  ...
  }, /*#__PURE__*/_react.default.createElement(_FundRaisersPreview.default, {
    fundraiser: data,
    isLoading: isLoading,
