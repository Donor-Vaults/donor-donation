...
var initialSelectedIndex = options.findIndex(function (_ref) {
  var value = _ref.value;
  return value === "bar";
});
var SmallCard2 = function SmallCard2(props) {
  ...
  var LineWidth = _styledComponents.default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  width: 80%;\n\n  @media only screen and (max-width: 768px) {\n    width: 90%;\n  }\n"])));
  var Ww = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n"])));
  return /*#__PURE__*/_react.default.createElement(Box, null, /*#__PURE__*/_react.default.createElement("svg", {
    width: "126",
    height: "126",
    viewBox: "0 0 126 126",
    fill: "none",
    ...
    d: "M63 0C28.2094 0 0 28.2094 0 63C0 97.7906 28.2094 126 63 126C97.7906 126 126 97.7906 126 63C126 28.2094 97.7906 0 63 0ZM90.2109 42.4266L60.5953 83.4891C60.1814 84.0668 59.6357 84.5376 59.0035 84.8623C58.3713 85.1871 57.6709 85.3565 56.9602 85.3565C56.2494 85.3565 55.549 85.1871 54.9168 84.8623C54.2846 84.5376 53.7389 84.0668 53.325 83.4891L35.7891 59.1891C35.2547 58.4437 35.7891 57.4031 36.7031 57.4031H43.2984C44.7328 57.4031 46.0969 58.0922 46.9406 59.2734L56.9531 73.1672L79.0594 42.5109C79.9031 41.3438 81.2531 40.6406 82.7016 40.6406H89.2969C90.2109 40.6406 90.7453 41.6813 90.2109 42.4266Z",
    fill: "#60FF70"
  })), /*#__PURE__*/_react.default.createElement(LineWidth, null, /*#__PURE__*/_react.default.createElement(Ww, null, /*#__PURE__*/_react.default.createElement(_Page.H, null, "70%"), /*#__PURE__*/_react.default.createElement(_Page.H, null, "30%")), /*#__PURE__*/_react.default.createElement(_rcProgress.Line, {
    percent: 70,
    strokeWidth: 4,
    strokeColor: "#34F072"
  })), /*#__PURE__*/_react.default.createElement(Container, null, /*#__PURE__*/_react.default.createElement(Flex, null, /*#__PURE__*/_react.default.createElement(_Navbar.Button, {
    style: {
      borderRadius: '1.5rem',
      width: '9rem',
      margin: '0.5rem 0 0 0',
  ...
  }, "Yes"), /*#__PURE__*/_react.default.createElement(_Navbar.Button, {
    style: {
      borderRadius: '1.5rem',
      width: '9rem',
      margin: '0.5rem 0 0 0',
  ...
  }, "No"))), /*#__PURE__*/_react.default.createElement(Lower, null, /*#__PURE__*/_react.default.createElement(_Page.T, {
    style: {
      fontSize: '1rem'
    }
  }, "Created: Feb 13, 2020 20:43 IST (+05:30)"), /*#__PURE__*/_react.default.createElement(_Page.T, {
    style: {
      fontSize: '1rem'
    }
  }, "Executed: Feb 14, 2020 20:24 IST (+05:30)")));
};
var _default = SmallCard2;
