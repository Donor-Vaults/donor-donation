...
var Registration = _styledComponents.default.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  width: 1200px;\n\n  display: flex;\n  border-radius: 1.75rem;\n  box-shadow: rgba(50, 50, 93, 0.25) 0px 50px 100px -20px,\n    rgba(0, 0, 0, 0.3) 0px 30px 60px -30px,\n    rgba(10, 37, 64, 0.35) 0px -2px 6px 0px inset;\n  align-items: center;\n  justify-content: space-between;\n  background-color: #fff;\n\n  @media only screen and (max-width: 1300px) {\n    width: 98%;\n  }\n  @media only screen and (max-width: 1100px) {\n    display: grid;\n\n    grid-template-columns: repeat(2, minmax(50%, 1fr));\n    place-items: center;\n  }\n  @media only screen and (max-width: 768px) {\n    display: flex;\n    flex-direction: column;\n  }\n"])));
;
...
var Margin = _styledComponents.default.div(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  @media only screen and (max-width: 1100px) {\n    margin: 0 0 1rem 0;\n  }\n  @media only screen and (max-width: 768px) {\n    margin: 1rem 0;\n  }\n"])));
var Register1 = function Register1() {
  var dispatch = (0, _reactRedux.useDispatch)();
  var _useState = (0, _react.useState)("hahzeb8285@gmail.com"),
  ...
  var handleConfirm = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var isPasswordValid, isEmailValid, authentication, authResp;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            isPasswordValid = /^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[#?!@$%^&*-]).{8,}$/.test(password);
          ...
          case 8:
            setLoading(true);
            authentication = (0, _auth.getAuth)();
            _context.prev = 10;
            _context.next = 13;
            return (0, _auth.createUserWithEmailAndPassword)(authentication, email, password);
          case 13:
          ...
          case 17:
            ...
            console.error("authError", _context.t0);
          case 20:
            setLoading(false);
          case 21:
          case "end":
  ...
  return /*#__PURE__*/_react.default.createElement(Width, null, /*#__PURE__*/_react.default.createElement(Registration, null, /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("p", {
    style: {
      fontSize: "1.2rem",
      margin: "0 0 0.5rem 0"
    }
