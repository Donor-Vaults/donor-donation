...
var Part1 = function Part1(_ref) {
  ...
  var getCountryCode = function getCountryCode(name) {
    var code = _countries.countries.find(function (item) {
  ...
  var validate = function validate() {
    ...
    if (!isValid(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[#$@!%&*?])[A-Za-z\d#$@!%&*?]{8,30}$/, info.password)) {
      _reactHotToast.default.error("Enter Valid Password");
      return false;
    }
    return true;
  };
  ...
  }, "Midle Name")), /*#__PURE__*/_react.default.createElement(Input, {
  ...
  }, console.log(info.country, 'ph'), /*#__PURE__*/_react.default.createElement(_reactPhoneNumberInput.default, {
    smartCaret: true,
    international: true,
    disabled: true,
    defaultCountry: getCountryCode(info.country ? info.country : "Afghanistan")
    // country="US"
    ,
    onChange: function onChange(r) {
      setInfo(_objectSpread(_objectSpread({}, info), {}, {
