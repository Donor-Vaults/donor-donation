...
var _countryDropdownWithFlagsForReact = _interopRequireDefault(require("country-dropdown-with-flags-for-react"));
require("react-phone-number-input/style.css");
var _input = require("react-phone-number-input/input");
require("../../1Registration/Wwe.css");
var _countryListWithDialCodeAndFlag = _interopRequireDefault(require("country-list-with-dial-code-and-flag"));
var _countries = _interopRequireDefault(require("../../../config/countries"));
require("react-select-search/style.css");
var _reactSelectSearch = _interopRequireDefault(require("react-select-search"));
var _reactCountryDropdown = require("react-country-dropdown");
require("react-country-dropdown/dist/index.css");
...
function OneCountryItem(props, option, snapshot, className) {
  ...
  return /*#__PURE__*/_react.default.createElement("button", _extends({}, props, {
    ...
    width: "28",
    height: "28",
    src: "https://flagcdn.com/40x30/".concat(option.code.toLowerCase(), ".png")
...
var Part1 = function Part1(_ref) {
  ...
  var isValid = function isValid(regex, value) {
  ...
  var validate = function validate() {
    ...
    if (!(0, _input.isValidPhoneNumber)(info.mobile)) {
      _reactHotToast.default.error("Enter Valid Mobile");
      return false;
    }
    var emailRegex = /^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/;
    if (!isValid(emailRegex, info.email)) {
      _reactHotToast.default.error("Enter Valid Email");
      return false;
    }
    if (!isValid(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[#$@!%&*?])[A-Za-z\d#$@!%&*?]{8,30}$/, info.password)) {
      _reactHotToast.default.error(" password must contain at least eight characters, at least one number and both lower and uppercase letters and special characters");
      return false;
    }
    return true;
  };
  ...
  (0, _react.useEffect)(function () {
    if (info) {
      var fullName = "".concat(firstName + " " + middleName + " " + lastName);
      setInfo(_objectSpread(_objectSpread({}, info), {}, {
        name: fullName
      }));
    }
  }, [firstName, middleName, lastName]);
  var getSelectedCountryCode = function getSelectedCountryCode() {
    var countryName = info.country.includes("(") ? info.country.substring(0, info.country.indexOf(" (")).trim() : info.country;
    var country = _countries.default.filter(function (item) {
  ...
  return /*#__PURE__*/_react.default.createElement(Box, {
  ...
  }, /*#__PURE__*/_react.default.createElement(Left, null, /*#__PURE__*/_react.default.createElement("div", {
    style: {
      width: "100%"
    }
  ...
  }, "Middle Name")), /*#__PURE__*/_react.default.createElement(Input, {
  ...
  }, /*#__PURE__*/_react.default.createElement(_countryDropdownWithFlagsForReact.default, {
    id: "UNIQUE_ID",
  ...
  }, info.country ? /*#__PURE__*/_react.default.createElement(Input, {
    type: "text",
    disabled: true
    //value={"21 July 2022. 1200 UTC+1"}
    ,
    ...
    onChange: function onChange(t) {
      var mobile = getSelectedCountryCode() + t.target.value;
      setInfo(_objectSpread(_objectSpread({}, info), {}, {
        mobile: mobile
      }));
    },
