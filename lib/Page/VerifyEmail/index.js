...
var VerifyEmail = function VerifyEmail() {
  ...
  var handleResetPassword = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var query, headers, graphqlQuery, options, response, data, accessToken;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 12:
            ...
            accessToken = data.data.verifyEmail.accessToken;
            localStorage.setItem("accessToken", accessToken);
            console.log(data); // data

            _reactHotToast.toast.success("Email Successfully Verified");
            window.location.href = "/";
            _context.next = 25;
            break;
          case 21:
  ...
  return /*#__PURE__*/_react.default.createElement(ParentContainer, null, /*#__PURE__*/_react.default.createElement(Width, null, /*#__PURE__*/_react.default.createElement("div", {
    className: "loader"
  }), /*#__PURE__*/_react.default.createElement("h3", null, "Verifying Email")));
};
