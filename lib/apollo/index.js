...
exports.default = exports.SIGNUPQUERY = exports.LoginQuery = exports.GetUser = exports.GetAllFundraisers = exports.ForgetPasswordQuery = exports.CreateFundRaisers = exports.ChangePassword = void 0;
...
var ForgetPasswordQuery = (0, _client.gql)("\nmutation resetPasswordByLink($email:String!){\n  passwordresetRequestByLink(data:{email:$email}){\n    accessToken\n    link\n  }\n}");
exports.ForgetPasswordQuery = ForgetPasswordQuery;
