...
exports.default = exports.backgroundColor = exports.Link1 = exports.Image = exports.IconContainer = exports.Button = void 0;
...
var Hr = _styledComponents.default.a(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\ndisplay: flex;\nmargin: 0;\nalign-items: center;\ntext-decoration: none;\ncolor: #FFF !important;\ncursor: pointer;\n@media only screen and (max-width: 768px) {\n  \n}\n"])));
var Mobile = _styledComponents.default.div(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  display: none;\n  @media only screen and (max-width: 1200px) {\n    display: block;\n    //margin: 0 2rem 0 0;\n    background: red;\n  }"])));
var PC = _styledComponents.default.div(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\ndisplay: block;\n@media only screen and (max-width: 1200px) {\n  display: none;\n}"])));
var Button = (0, _styledComponents.default)(_reactScroll.Link)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  background-color: rgba(2, 169, 92, 1);\n  border: none;\n  border-radius: 2rem;\n  padding: 0 1.5rem;\n  color: #FFF;\n  font-size: 1.2rem;\n  height: 3.5rem;\n  cursor: pointer;\n  display: grid;\n  place-items: center;\n  box-shadow: rgba(50, 50, 93, 0.25) 0px 50px 100px -20px, rgba(0, 0, 0, 0.3) 0px 30px 60px -30px, rgba(10, 37, 64, 0.35) 0px -2px 6px 0px inset;\n"])));
exports.Button = Button;
var IconContainer = _styledComponents.default.div(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  \n  margin: 0 8vw 0 2rem;\n  @media only screen and (max-width: 1600px) {\n    margin: 0 6rem 0 0;\n  }\n  @media only screen and (max-width: 1200px) {\n    margin: 0 10rem 0 0;\n  }\n  @media only screen and (max-width: 768px) {\n    display: none;\n  }\n \n"])));
exports.IconContainer = IconContainer;
var Image = (0, _styledComponents.default)(_framerMotion.motion.img)(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  cursor: pointer;\n"])));
exports.Image = Image;
...
var Navbar = function Navbar() {
  ...
  return /*#__PURE__*/_react.default.createElement("nav", {
  ...
  }, /*#__PURE__*/_react.default.createElement(Link2, {
    to: "/allfundraiser",
    spy: true,
    smooth: true,
    offset: -80
  }, "Fundraiser"), /*#__PURE__*/_react.default.createElement(Link2, {
    to: "/vault",
    spy: true,
    smooth: true,
    offset: -80
    ...
    smooth: true,
    offset: -80
  }, "Start a Fundraise"), /*#__PURE__*/_react.default.createElement(Link2, {
    to: "/docs",
    spy: true,
    smooth: true,
    offset: -80
