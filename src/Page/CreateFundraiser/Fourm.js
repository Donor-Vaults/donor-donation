...
const Fourm = ({ onNext, hide, onBack }) => {
    ...
    <Sec style={{ display: hide ? "none" : "" }}>
      <Width>
        <Left>
          ...
          <Margin>
            <H style={{ color: "#000" }}>BEGIN YOUR FUNDRAISING</H>
            <T style={{ color: "#000" }}>
              We'll help you complete it successfully
            </T>
          </Margin>
        </Left>
          ...
          <Details>
            <div style={{ margin: "3rem 0 0 0" }}>
              <T style={{ margin: "0 0 0.5rem 0", fontSize: "1.6rem" }}>
                Choose a category that best describes your fundraise category.
              </T>
              <Grid>
                <Tag
                  Text="Animals"
