...
const FourmPage5 = ({ onNext, hide, onBack }) => {
  ...
  const handleUpload = async () => {
    try {
      const url = await uploadFile(data.supportingDocuments[0]);
      setDocumentUrl(url);
    } catch (err) {
          ...
          <Details>
            <div>
              ...
              >
                ...
                >
                  Click here to select supporting document
                </div>
                ...
                <input
                  ...
                  onChange={(f) => {
                    ...
                    if (f.target.files.length > 0) {
                      ...
                      setData({ supportingDocuments: files });
                    }
                  }}
                  style={{ display: "none" }}
                />
